...
// ✅ NUEVO: Variable para DataTables de Items (adaptado de CrearAcuerdo)
...
$(document).ready(function () {
    ...
    $("#modalConsultaItems").on("show.bs.modal", function () {
        ...
        // ✅ Limpiar DataTable previo si existe
        if (dtItemsConsulta) {
            dtItemsConsulta.destroy();
            dtItemsConsulta = null;
        }
    ...
    // ✅ ADAPTADO: checkTodosItems solo aplica a la página actual visible
    ...
    // ✅ ADAPTADO DE CREARACUERDO: Usa DataTables API para capturar checks de TODAS las páginas
    $("#btnSeleccionarItems").on("click", function () {
        const itemsSeleccionados = [];

        if (dtItemsConsulta) {
            // Usar la instancia de DataTable para obtener TODOS los checks, incluso de otras páginas
            dtItemsConsulta.$('.item-checkbox:checked').each(function () {
                const $checkbox = $(this);
            ...
            // Fallback clásico por si algo falla
        ...
        if (dtItemsConsulta) {
            dtItemsConsulta.$(".item-checkbox").prop("checked", false);
        }
    });
...
// ===================================================================
// ✅ CONSULTAR ITEMS - REESCRITO CON DATATABLES (ADAPTADO DE CREARACUERDO)
// ===================================================================
function consultarItems(filtros = {}) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            // ✅ Construir el array de datos para DataTables (adaptado de CrearAcuerdo)
            ...
            // ✅ Inicializar DataTables para ítems
            dtItemsConsulta = $("#tablaItemsConsulta").DataTable({
                ...
                columnDefs: [
                    { targets: [0, 4, 5, 6, 8, 10, 12], className: "text-center align-middle" },
                    { targets: [3, 7, 9, 11, 13], className: "text-end align-middle text-nowrap" },
            ...
            // ✅ Conectar input de búsqueda personalizado con DataTables
            $("#buscarItemInput").off("keyup").on("keyup", function () {
...
// ✅ ADAPTADO DE CREARACUERDO: Incluye columna Margen Crédito (12 columnas)
...
// ✅ ADAPTADO DE CREARACUERDO: Calcula Margen Crédito + colorea márgenes negativos
function calcularTotalesItems() {
    ...
    $("#tablaItemsBody tr:visible").each(function () {
        ...
        // ✅ Fórmula adaptada de CrearAcuerdo: (precio + aporte - costo) / precio * 100
        if (precioContado > 0) {
        ...
        // ✅ Colorear márgenes negativos en rojo, positivos en verde
...
// ✅ ADAPTADO: Lee también margen crédito
