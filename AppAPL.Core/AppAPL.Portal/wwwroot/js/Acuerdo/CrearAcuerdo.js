...
(function () {
    ...
    $(document).ready(function () {
        ...
        $("#checkTodosItems").on("change", function () {
            const isChecked = $(this).is(":checked");
            if (dtItemsConsulta) {
                // Aplica a TODOS los nodos en la memoria de DataTables, no solo en la página actual
        ...
        $("#btnSeleccionarItems").on("click", function () {
            ...
            // Lee los elementos marcados en todas las páginas de la tabla
            const checkboxes = dtItemsConsulta ? dtItemsConsulta.$(".item-checkbox:checked") : $("#tablaItemsConsulta tbody .item-checkbox:checked");
            ...
            // Limpiar checks después de agregar
